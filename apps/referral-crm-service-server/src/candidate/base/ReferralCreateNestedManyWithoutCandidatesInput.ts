...
@InputType()
class ReferralCreateNestedManyWithoutCandidatesInput {
...
export { ReferralCreateNestedManyWithoutCandidatesInput as ReferralCreateNestedManyWithoutCandidatesInput };
